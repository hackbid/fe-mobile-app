        ...
        <View>
            ...
            <View
                ...
                <View style={{ width: 120 }}>
                    <Text className='text-gray-700 text-2xl font-bold' style={{ lineHeight: 35 }}>
                        Image Carousel {id}
                    </Text>
                </View>
                <View>
                    <Text className='text-slate-50 text-xs font-semibold bg-blue-800 px-4 py-2' style={{ borderRadius: 12 }}>
                        Detail item
                    </Text>
                </View>
            </View>
            <View
                ...
                <Text className='text-gray-700 text-center text-2xl py-1 font-bold'>Rp. 25.000,-</Text>
            ...
            <ScrollView
                ...
                <View className='my-2'>
                    ...
                    <Text className='text-slate-50 bg-slate-400 py-3 px-3 w-60' style={{ borderRadius: 10 }}>
                ...
                <View className='my-2 self-end'>
                    ...
                    <Text className='text-slate-50 bg-blue-800 py-3 px-3 w-60 text-right' style={{ borderRadius: 10 }}>
                        isi chat yang dikirim user
                    </Text>
                </View>
                <View className='my-2'>
            ...
            <View className='bg-yellow-400 w-5/6 p-3 mx-auto rounded-xl' style={{ top: -20 }}>
                <Text className='text-center font-bold text-lg text-gray-600'>Request Bid</Text>
            </View>
        </View>
    );
}
